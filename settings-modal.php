  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-md">
    <div class="modal-content">
      <div class="modal-header rounded-0">
        <h1 class="modal-title fs-5" id="staticBackdropLabel">Configuración de los datos de la factura</h1>
        ...
        <div class="container-fluid">
          <form action="./?action=update_settings" id="settings-form" method="POST">
            <div class="row">
              <div class="col-12">
                <div class="mb-3">
                  <label for="store_name" class="form-label">Nombre del Negocio</label>
                  <input type="text" class="form-control" id="store_name" name="store_name" value="<?= $invoice_settings['store_name'] ?? "" ?>" required="required">
                </div>
                <div class="mb-3">
                  <label for="store_address" class="form-label">Dirección del negocio</label>
                ...
                <div class="mb-3">
                  <label for="store_contact" class="form-label">Datos de Contacto</label>
                ...
                <div class="mb-3">
                  <label for="store_contact" class="form-label">Nota del Pie de Página</label>
      ...
      <div class="modal-footer rounded-0">
        <button type="submit" form="settings-form" class="btn btn-primary">Actualizar</button>
